...
Contributions to chocolatey-language-server are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from chocolatey-language-server and how it can be made better.
